...
public class Projectile extends GameObject implements Poolable {
    ...
    public Projectile(GameController gc) {
        ...
        this.speed = 640.0f;
        this.ownerType = Tank.Owner.PLAYER;
    }

    public void setup(Vector2 startPosition, float angle, TextureRegion texture, int power, Tank.Owner ownerType) {
